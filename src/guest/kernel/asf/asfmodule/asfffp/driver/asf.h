...
/* Subha: previously 4 */
#define ASF_FFP_FLOW_INAC_DIVISOR	(1)
...
ASF_uint32_t ASFCreateVSG(ASF_uint32_t, ASF_uint32_t);
ASF_uint32_t ASFDeleteVSG(ASF_uint32_t);
...
typedef ASF_void_t (*ASFFwdFn_f)
	(ASF_uint32_t, ASF_uint32_t, ASFBuffer_t, genericFreeFn_t, ASF_void_t *); 
void ASFFFPRegisterFwdFunctions(ASFFwdFn_f pFn);

typedef ASF_uint32_t (*ASFFwd6Fn_f)
	(ASF_uint32_t, ASF_uint32_t, ASFBuffer_t, genericFreeFn_t, ASF_void_t *); 
ASF_void_t ASFFFPRegisterFwd6Functions(ASFFwd6Fn_f pFn);
